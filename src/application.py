    ...
    with open(file, 'rb') as f:
        ...
        while True:
            ...
            while not ack_received:
                ...
                print("Data packet sent to the server:", packet)
...
def gbn_client(drtp, file):
    with open(file, 'rb') as f:
        ...
        while True:
            ...
            while next_seq_num < base + args.window_size and not packets_in_window and len(
                    packets_in_window) < args.window_size:
                data = f.read(1460)
                if not data:
                    break
