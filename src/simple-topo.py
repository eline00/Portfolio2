...
class NetworkTopo( Topo ):
    ...
    def build( self, **_opts ):		
        ...
        self.addLink(h1,r2,params1={ 'ip' : '10.0.0.1/24' },params2={ 'ip' : '10.0.0.2/24' }, bw=100, delay='50ms')#,max_queue_size=834, use_htb=True)
        self.addLink(r2,h3,params1={ 'ip' : '10.0.1.1/24' },params2={ 'ip' : '10.0.1.2/24' }, bw=100, delay='50ms', max_queue_size=170)#, max_queue_size=834, use_htb=True)
